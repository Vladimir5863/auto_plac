...
@section('title', 'Moje uplate - Profil - Auto Plac')

@section('content')
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-credit-card me-2"></i>Moje uplate</h2>
        <div class="badge bg-primary fs-6">Ukupno: €{{ number_format($totalAmount, 2, ',', '.') }}</div>
    </div>
    ...
    @else
        <div class="text-center py-5">
            ...
            <h4>Nemate uplata</h4>
            <p class="text-muted">Kada izvršite uplatu za isticanje oglasa, videćete je ovde.</p>
        </div>
    @endif
</div>
@endsection
